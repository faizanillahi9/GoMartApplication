...
namespace GoMartApplication
{
    public partial class SellingForm : Form
    {
        ...
        private void dataGridView2_Product_Click_1(object sender, EventArgs e)
        {
            try
            {
                txtProdID.Clear();
                ...
                //txtQty.Text = dataGridView2_Product.SelectedRows[0].Cells[4].Value.ToString();
                txtQty.Clear();
                txtQty.Focus();
            }
            catch (Exception ex)
        ...
        private void btnAddBill_Details_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cmd.Parameters.AddWithValue("@TotalAmt", Convert.ToInt32(GrandTotal));
                    cmd.CommandType = CommandType.StoredProcedure;
                    dbCon.OpenCon();
                    ...
                    {
                        BindBillList();
                        MessageBox.Show("Bill added Sucessfully...", "Sucess");
        ...
        private void btnAddOrder_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Enter valid Qunatity or Price", "Error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
